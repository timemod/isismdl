...
source("functions/zoem_starting_values.R")
source("functions/isismdl_starting_values.R")

model_file <- "toy_model3.mdl"
...
data_init <- read_ts_xlsx("data_init.xlsx")
...
dependency_paths_isismdl <- find_dependency_paths_isismdl("bond", "management_fee_quote",
                                                  dependency_structure = dependency_structure)
print(dependency_paths_isismdl)
